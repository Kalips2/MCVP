...
public class AlbumServiceTest {
  ...
  public void testGetByIdThrowException() {
    Exception exception = assertThrows(InternalException.class, () -> albumService.getById(999L));
  ...
  public void testUpdateThrowAlbumIsNotFoundException() {
    ...
    Exception exception = assertThrows(InternalException.class, () -> albumService.update(999L, albumData, file));
  ...
  public void testUpdateThrowLabelIsNotFoundException() {
    AlbumData albumData = new AlbumData("Non-existent Album", "2022-01-01", 1L, 999L);
  ...
  public void testUpdateThrowArtistIsNotFoundException() {
    AlbumData albumData = new AlbumData("Non-existent Album", "2022-01-01", 999L, 1L);
    Exception exception = assertThrows(InternalException.class, () -> albumService.update(testAlbums.get(0).getId(), albumData, file));
  ...
  public void testDeleteThrowAlbumsIsNotFoundException() {
    Exception exception = assertThrows(InternalException.class, () -> albumService.delete(999L));
