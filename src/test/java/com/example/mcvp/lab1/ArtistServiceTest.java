...
public class ArtistServiceTest {
  ...
  public void testGetByIdThrowException() {
    Exception exception = assertThrows(InternalException.class, () -> artistService.getById(999L));
  ...
  public void testUpdateThrowArtistIsNotFoundException() {
    ...
    Exception exception = assertThrows(InternalException.class, () -> artistService.update(999L, artistData));
  ...
  public void testDeleteThrowArtistIsNotFoundException() {
    Exception exception = assertThrows(InternalException.class, () -> artistService.delete(999L));
